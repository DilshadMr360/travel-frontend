                ...
                <div className='flex items-center justify-center w-8/12 mx-auto mt-2 md:w-4/12 md:-mt-10'>
                    <div className="w-full mx-5 space-y-8">
                        ...
                        <form className=" md:space-y-10" action="#" method="POST">
                            <input type="username" value={username} onChange={(e) => setUserName(e.target.value)} placeholder="User Name" className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none" />
